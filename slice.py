...
# within the FIELDSET directory of datasets in hyperspectral_pix2pix.
#
...
def main():
    parser = argparse.ArgumentParser(description="Slice and organize hyperspectral image data.")
    ...
    un_sliced_dir = os.path.expanduser('~/hyperspectral_pix2pix/datasets/FIELDSET/UN_SLICED')
